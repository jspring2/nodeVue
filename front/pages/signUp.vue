            ...
            <v-card>
                <v-container>
                    ...
                    <v-form ref="form" v-model="valid" @submit.prevent="onSubmitForm">
                        ...
                        <v-text-field v-model="passwordCheck" label="비밀번호 확인" type="password" :rules="passwordCheckRules" required />
                        <v-text-field v-model="nickname" label="닉네임" type="nickname" :rules="nicknameRules" required />
                        <v-checkbox v-model="terms" required label="동의 하면 체크" :rules="[v=>!!v || '약관에 동의해야 합니다.']"/>
                        <v-btn color="green" type="submit">가입</v-btn>
                    </v-form>
                </v-container>
            </v-card>
        </v-container>
